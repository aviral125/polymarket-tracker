 ...
 */
export const extractColor = async (imageSource) => {
  return new Promise(async (resolve) => {
    ...
    try {
      ...
      if (imageSource instanceof File || imageSource instanceof Blob) {
        ...
        // Fetch the image as a blob to avoid CORS taint
 ...
 * Works with both File objects and image URLs
 */
export const createBlurredImage = async (imageSource) => {
  return new Promise(async (resolve) => {
    const img = new Image();
    let blobUrl;
    ...
    try {
      ...
      console.error('Error fetching image as blob for blur:', error);
      resolve(null);
    }
  });
};
